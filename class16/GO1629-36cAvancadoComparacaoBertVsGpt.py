...
class TransformerComparison:
    ...
    def compare_attention_masks(self, text="The cat sat on the mat"):
        ...
        axes[0].set_ylabel('Posição da Consulta')
        ...
        plt.colorbar(im1, ax=axes[0], label='Pode Atender (1=Sim)')
        ...
        axes[1].set_ylabel('Posição da Consulta')
        ...
        plt.colorbar(im2, ax=axes[1], label='Pode Atender (1=Sim)')
    ...
    def compare_embeddings(self, sentences):
        ...
        for idx, sentence in enumerate(sentences):
            ...
            axes[idx, 0].set_ylabel('Dimensão Oculta')
            axes[idx, 0].set_xlabel('Posição do Token')
            ...
            axes[idx, 1].set_ylabel('Dimensão Oculta')
            axes[idx, 1].set_xlabel('Posição do Token')
